...
//    private class Deserializer implements Function<DataSnapshot, List<Photo>> {
//        public List<Photo> apply(DataSnapshot dataSnapshot) {
//            return (List<Photo>) dataSnapshot.getValue(Photo.class);
//        }
//    }
